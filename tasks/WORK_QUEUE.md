...
| 35 | M30 | Phase 0 + Phase 1a + fail-closed Phase 1b policy preparation + schema-v2 qsp3 target binding implemented locally; full local gate passes; campaign blocked | policy validation remains trust/auth false and 0/24; managed browser, external trust/raw derivation/ledger/dirfd hardening, protected exact candidate, 24 operated/independent/owner controls and corpus execution are absent |
