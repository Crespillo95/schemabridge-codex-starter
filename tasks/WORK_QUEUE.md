...
| 35 | M30 | Phase 0 + Phase 1a + fail-closed Phase 1b policy preparation + schema-v2 qsp3 target binding published on draft PR #1; D137 descriptor I/O, D138 bounded subprocess streaming, the 174-test M30 cut and 4,073-test full local gate pass; campaign blocked | policy validation remains trust/auth false and 0/24; managed browser, external trust/raw derivation/CAS ledger, dedicated evaluator/fd-consumption/mount isolation, protected exact candidate, 24 operated/independent/owner controls and corpus execution are absent |
