...
M30_REQUIRED_SOURCE_PATHS: Mapping[str, str] = MappingProxyType(
    {
        ...
        "m30_control_policy_application": "src/schemabridge/application/production_control_policy.py",
        "m30_control_policy_cli": "scripts/m30_validate_control_policy.py",
        "m30_control_policy_domain": "src/schemabridge/domain/production_campaign_receipts.py",
        "m30_control_policy_guide": "docs/20_M30_PHASE1B_CONTROL_POLICY.md",
